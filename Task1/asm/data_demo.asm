; ============================================================
; data_demo.asm — BIT 4220 Task 1: Data Representation Demo
; Demonstrates: bytes/words/dwords, ASCII, two's complement,
;               little-endian storage
; Build:
;   nasm -f elf64 data_demo.asm -o data_demo.o
